...
document.addEventListener("DOMContentLoaded", function () {
    ...
    daysSelectors.forEach(function (daySelector) {
        daySelector.addEventListener("click", toggleDaySelection);
    });

    clearDaysButton.addEventListener("click", clearSelectedDays);
    submitButton.addEventListener("click", handleSubmit);
    halfDayButton.addEventListener("click", function() { setRate(costPerDayHalf, halfDayButton, fullDayButton); });
    fullDayButton.addEventListener("click", function() { setRate(costPerDayFull, fullDayButton, halfDayButton); });
});
